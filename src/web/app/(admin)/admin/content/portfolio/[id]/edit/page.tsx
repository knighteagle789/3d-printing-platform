  ...
  if (isLoading) {
    return (
      <div className="space-y-4 max-w-2xl">
        ...
        {[...Array(4)].map((_, i) => <div key={i} className="h-16 bg-surface-alt animate-pulse" />)}
      </div>
    );
  }
    ...
    <div className="space-y-6 max-w-2xl">
      ...
      <div className="flex items-start justify-between gap-4">
        ...
        <div className="flex items-center gap-2 shrink-0 pt-1">
          {raw?.isFeatured && (
            <span className={`${mono.className} inline-flex items-center gap-1 text-[8px] uppercase tracking-[0.12em] text-accent`}>
